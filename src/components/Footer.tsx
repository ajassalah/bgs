      ...
      <div className="container">
        <div className={styles.top}>
          ...
          <div className={styles.linksGrid}>
            ...
            <div className={styles.linkColumn}>
              <h3>Contact Us</h3>
              <a href="tel:+447566756499" className={styles.contactItem}>
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"></path></svg>
                +44 756 675 6499
              </a>
              <a href="mailto:info@britishgraduateschool.co.uk" className={styles.contactItem}>
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path><polyline points="22,6 12,13 2,6"></polyline></svg>
                info@britishgraduateschool.co.uk
              </a>
              <a href="https://www.google.com/maps/search/?api=1&query=Leicester%2C%20United%20Kingdom" target="_blank" rel="noopener noreferrer" className={styles.contactItem}>
        ...
        <div className={styles.middleRow}>
          ...
          <div className={styles.partnerLogos}>
            <Image src="/cghe_logo.png" alt="CQHE Logo" width={80} height={80} className={styles.partnerLogo} />
            <Image src="/nqual logo.jpeg" alt="NQUAL Logo" width={80} height={80} className={styles.partnerLogo} style={{ borderRadius: '50%', objectFit: 'cover' }} />
            <Image src="/qualifi-endorsed-729x800.png" alt="Qualifi Logo" width={80} height={80} className={styles.partnerLogo} />
          </div>
