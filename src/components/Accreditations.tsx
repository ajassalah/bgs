...
export default function Accreditations() {
  const partners = [
    { 
      ...
      label: "Recognition",
      icon: (
        <svg viewBox="0 0 24 24" width="48" height="48" fill="none" stroke="#a0142d" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
